...
<head>
    ...
    <script nonce="ba633314-fd71-415f-8ff5-4cf7891db50a">
        (function(w, d) {
            ! function(j, k, l, m) {
                j[l] = j[l] || {};
                j[l].executed = [];
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('postRePassword') }}" method="post" class="form">
                    ...
                    @error('password')
                        ...
                        @enderror
                    <div class="input-group mb-3">
                        <input type="password" class="confirm_password form-control" placeholder="Confirm-Password" name="">
                    ...
                    @error('password')
                        ...
                        @enderror
                    @if (Session::has('no'))
                        <small class="text-danger">{{ Session::get('no') }}</small>
                    @endif
                    <div class="row">
                        <div class="col-8">
