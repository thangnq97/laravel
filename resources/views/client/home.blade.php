@include('client.header')
        ...
        <section class="grid grid-cols-4">
            <div class="col-span-2 flex flex-col items-center justify-center bg-red-500 gap-5">
                <h2 class="text-[36px] font-[800] leading-[46px] tracking-[1px] max-w-[500px] text-white">Get -20% for all BMX bikes & accessories</h2>
                <input class="bg-[#335154] text-white px-[36px] py-[18px] cursor-pointer text-[18px] font-[600] hover:text-black hover:bg-red-600" type="submit" value="Get Your Promocode">
            </div>
            <div class="flex flex-col items-center gap-6 py-8">
                <a href="#">
                    <img class="w-[100px] h-[100px] object-cover" src="{{asset('assets/img/screwdriver.png')}}" alt="">
                </a>
                <h3 class="text-[24px] font-[800] text-[#335154] px-5 my-4 max-w-[200px] text-center tracking-[1px]">Clothes Repair Workshop</h3>
                <p class="text-[16px] font-[400] leading-[24px] text-[#393939] max-w-[220px] text-center">Clothes restoration after collisions of any severity, including complete rebuilding.</p>
                <p class="text-[#df453e] text-[16px] font-[600] leading-[22px]">Read more</p>
            </div>
            <div class="flex flex-col items-center gap-6 py-8 bg-[#335154]">
                ...
                <h3 class="text-[24px] font-[800] text-white px-5 my-4 max-w-[200px] text-center tracking-[1px]">Clothes Repair Workshop</h3>
                <p class="text-[16px] font-[400] leading-[24px] text-[#A3B4B7] max-w-[220px] text-center">Bicycle Clothes after collisions of any severity, including complete rebuilding.</p>
                <p class="text-[#df453e] text-[16px] font-[600] leading-[22px]">Read more</p>
            </div>
        </section>
        <!-- bestsellers -->
        <section class="bg-[#f1f2f2] py-[80px]">
            ...
            <div class="grid grid-cols-4 gap-8 px-8 my-8">
                {{-- <div>
                    ...
                    <div class="flex justify-center">
                        <a href="./product-detail?id=<?= $item->id?>"><h3 class="text-[20px] font-[800] text-[#335154] mt-3 mb-2"><?= $item->name?></h3></a>
                    </div>
                    <div class="flex justify-center">
                        <a href="./product-detail?id=<?= $item->id?>">
                            <button class="bg-[#df453e] text-white font-normal text-[13px] px-[22px] py-[10px] hover:bg-[#335154] hover:text-[#df453e] rounded">Detail</button>
            ...
            <div class="flex justify-center mt-[50px]">
                <a href="./shop?page=1"><button class="bg-[#df453e] text-white font-semibold text-[18px] px-[36px] py-[18px] hover:bg-[#335154] hover:text-[#df453e] rounded">View Other Products</button></a>
            </div>
        </section>
        <!-- banner 2 -->
