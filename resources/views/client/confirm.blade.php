        ...
        <section>
            <form class="form w-[80%]" action="" method="POST">
                ...
                <div class="mb-4">
                    ...
                    @error('fullname')
                        <p class="text-[13px] font-normal text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4 flex justify-between gap-3">
                    <div class="flex-[1]">
                        <input class="email border pl-3 py-3 outline-none w-full focus:border-blue-400" type="email"
                    ...
                    <div class="flex-[1]">
                        <input class="phone border pl-3 py-3 outline-none w-full focus:border-blue-400" type="text"
                ...
                <div class="mb-4">
                    <input class="w-full border pl-3 py-3 outline-none w-[48%] focus:border-blue-400" type="text"
                ...
                <div>
                    <input class="w-full bg-red-500 text-white h-[50px] cursor-pointer uppercase text-[]" type="submit"
                        value="submit">
                    @if (session()->has('yes'))
                        <p class="text-[13px] font-normal text-red-500">{{ session()->get('yes') }}</p>
                    @endif
                </div>
            </form>
        </section>
