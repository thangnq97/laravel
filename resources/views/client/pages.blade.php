<?php require_once __DIR__."/header.php"?>
        ...
        <section class="my-9 grid grid-cols-5 gap-6">
            <div class="col-span-3 flex flex-col gap-5 px-6 justify-center">
                ...
                <p class="text-[#393939] text-[16px] font-[400]">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperiam eaque ipsa quae ab illo inventore.</p>
                <div class="flex flex-col gap-3">
                    <div class="flex gap-2 items-center">
                        <i class="text-red-600 fa-solid fa-circle-check"></i>
                        <p class="text-[#393939] text-[14px] font-[400]">Edquia numquam tempora incidunt ut labore et dolore magnam</p>
                    </div>
                    <div class="flex gap-2 items-center">
                        <i class="text-red-600 fa-solid fa-circle-check"></i>
                        <p class="text-[#393939] text-[14px] font-[400]">Exercitationem ullam corporis suscipit laboriosam volupatem</p>
                    </div>
                    <div class="flex gap-2 items-center">
                        <i class="text-red-600 fa-solid fa-circle-check"></i>
                        <p class="text-[#393939] text-[14px] font-[400]">Imilique sunt in culpa qui officia deserunt mollitia animi</p>
                    </div>
                    <div class="flex gap-2 items-center">
                        <i class="text-red-600 fa-solid fa-circle-check"></i>
                ...
                <div>
                    <button class="bg-[#df453e] text-white font-semibold text-[18px] px-[36px] py-[18px] hover:bg-[#335154] hover:text-[#df453e] rounded">Read More</button>
                </div>
            </div>
